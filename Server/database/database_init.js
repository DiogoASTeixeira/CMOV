...
.sync({force:true})
  .then(() => {
    User.bulkCreate([
      {id: "b0e76929-9762-45b7-be1f-2f37d2edf33c", username: "Fabio", name: "Fábio Azevedo", password:"famas", card_number:"123123", card_cvs: "101", total_spent: 0, hundred_multiples: 0, nif: "134", total_coffees: 0},
      {id: "32bf576f-1d83-4141-9009-8d4c6435d10e", username: "Diogo", name: "Diogo Teixeira", password:"teixas", card_number:"123124", card_cvs: "102", total_spent: 220, hundred_multiples: 2, nif: "456", total_coffees: 0},
    ])
  })
  .then(() => {
    ...
    .then(() => {
      Voucher.bulkCreate([
        {id: "b1a3k3v1-cte0-4ab3-b1ce-67cf4d3935ac", used:false, UserId:"b0e76929-9762-45b7-be1f-2f37d2edf33c", TransactionId:null},
        ...
        {id: "b1a3k3v1-cfd2-4ab3-b1ce-67cf4d3935ac", used:false, UserId:"32bf576f-1d83-4141-9009-8d4c6435d10e", TransactionId:null},
